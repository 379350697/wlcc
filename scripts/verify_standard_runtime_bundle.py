...
CHECKS = [
    ...
    ("reply-gated-flow-e2e", ["python3", "-m", "pytest", "tests/runtime/test_reply_gated_flow_e2e.py", "-q"]),
    ...
    ("check-reply-exit", ["python3", str(root / "scripts" / "check_reply_exit.py"), "--project-root", str(root), "--task-id", "task-phase2-e2e-single", "--reply-kind", "status", "--structured"]),
