...
## retrieved_context
{
  ...
  "task_state": [
    {
      "source": ".agent/state/tasks/real-close-runtime-debug-target.json",
      "content": {
        "taskId": "real-close-runtime-debug-target",
        "project": "wlcc",
        "goal": "debug close flow",
        "status": "doing",
        "priority": "P1",
        ...
        "isPrimaryTrack": true,
        "lifecycle": "ingested",
        "title": "close runtime debug target"
      }
    },
    {
      "source": ".agent/tasks/real-close-runtime-debug-target.md",
      "content": "# Task State\n\n- id: real-close-runtime-debug-target\n- project: wlcc\n- goal: debug close flow\n- status: doing\n- priority: P1\n- dependencies: []\n- override: none\n- latestResult: 真实任务已接入 runtime。\n- blocker: 无\n- nextStep: 进入 lifecycle=ingested，并等待正式推进。\n- updatedAt: 2026-04-06T22:58:33"
    },
    {
      "source": ".agent/resume/real-close-runtime-debug-target-resume.md",
      "content": "# Resume State\n\n- taskId: real-close-runtime-debug-target\n- 最后目标：debug close flow\n- 最后成功动作：真实任务 ingest 已完成。\n- 最后失败动作：无\n- 当前阻塞：无\n- 建议下一步：进入 lifecycle=ingested，并等待正式推进。\n- updatedAt: 2026-04-06T22:58:33"
    },
    {
  ...
  "meta": {
    ...
    "usedSources": [
      ...
      "TASKS.md",
      "INCIDENTS.md",
      ".agent/state/tasks/real-close-runtime-debug-target.json",
      ".agent/tasks/real-close-runtime-debug-target.md",
      ".agent/resume/real-close-runtime-debug-target-resume.md",
...
## resume_state
{
  "selectedTaskId": "real-close-runtime-debug-target",
  "selectionReasons": [
    "status-doing"
  ],
  "candidateCount": 1,
